...
public class UserRepositoryImpl implements UserRepository {
    ...
    public User saveUser(User user) {
        try {
            jdbcTemplate.update("INSERT INTO " + USER_TABLE + " VALUES (?, ?, ?, ?, ?, ?, ?, ?)", user.getEmail(),
                    user.getName(), user.getSurname(), user.getPassword(), user.getBirthdate(), user.getGender()
                            .toString(), user.getBalance(), user.getDescription());
    ...
    private class UserRowMapper implements RowMapper<User> {
        ...
        public User mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            String image = "data:image/png;base64," +
                    "iVBORw0KGgoAAAANSUhEUgAAAWwAAACLCAMAAAByd1MFAAAAflBMVEVra2v///++ADltbW1nZ2f8/PyPj4/rz9D7//9cXFz5" +
